...
if ( 1 == $blog_unique_design && 'first_post' === $unique_design_option && 1 == $alter_val && 0 == $prev_year && 1 == $paged ) { //phpcs:ignore
	...
	if ( 1 != $blog_unique_design && 1 == $alter_val ) { //phpcs:ignore
		...
		echo '<div class="media-grid-wrapper">';
	} elseif ( 1 == $blog_unique_design && 'first_post' === $unique_design_option && 1 == $paged ) { //phpcs:ignore
		if ( 2 == $alter_val && $column_setting <= 2 ) { //phpcs:ignore
			echo '<div class="media-grid-wrapper">';
		} elseif ( 3 == $alter_val && $column_setting >= 3 ) { //phpcs:ignore
			echo '<div class="media-grid-wrapper">';
		}
...
<?php
if ( 1 == $blog_unique_design && 'first_post' === $unique_design_option && 0 == $prev_year && 1 == $paged ) { //phpcs:ignore
	if ( $column_setting >= 3 && 2 == $alter_val ) { //phpcs:ignore
		echo '</div>';
	} elseif ( $column_setting <= 2 && 1 == $alter_val ) { //phpcs:ignore
		echo '</div>';
	}
} elseif ( 1 == $blog_unique_design && 'featured_posts' === $unique_design_option && $alter_val <= $count_sticky && 0 == $prev_year && 1 == $paged ) { //phpcs:ignore
	echo '</div>';
