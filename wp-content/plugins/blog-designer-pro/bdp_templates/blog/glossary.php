				...
				<div class="post_content-inner">
					<?php if ( 0 == $bdp_settings['rss_use_excerpt'] ) : //phpcs:ignore ?>
						...
						if ( '' != $bdp_excerpt_data ) { //phpcs:ignore
							...
							if ( $read_more_link == 1 && 0 != $bdp_settings['rss_use_excerpt'] ) { //phpcs:ignore
								...
								?>
								<div class="overlay" style="background:<?php echo Bdp_Utility::hex2rgba( $bdp_settings['template_content_hovercolor'], 0.9 ); //phpcs:ignore ?>">
