			...
			<main id="main" class="site-main" role="main">
				...
				<div class="bdp_single <?php echo esc_attr( $bdp_theme ) . ' ' . esc_attr( $bdp_display_related_post ); ?>">
					...
					while ( have_posts() ) :
						...
						if($bdp_theme == "brite" && isset($bdads_to_show_after) && 'author_content' === $bdads_to_show_after) {
                            do_action('bd_single_ads_display',$bdp_settings);
                        }
														...
														<a href="<?php esc_url( the_permalink() ); ?>" class="prev-link">
															...
															if ( has_post_thumbnail() && isset( $bdp_settings['display_pn_image'] ) && 1 == $bdp_settings['display_pn_image'] ) { //phpcs:ignore
																...
																<span class="navi-post-thumbnail">
																	<?php
																	echo apply_filters( 'bdp_nav_post_thumbnail_filter', get_the_post_thumbnail( get_the_ID(), $nav_thum_size, $nav_thumb_class ), get_the_ID() ); //phpcs:ignore
																	?>
																</span>
															<?php } ?>
															<div class="post-data">
						...
						if($bdp_theme != "news" && $bdp_theme != "timeline" && $bdp_theme != "story" && $bdp_theme != "brite" && isset($bdads_to_show_after) && 'author_content' === $bdads_to_show_after) {
                            do_action('bd_single_ads_display',$bdp_settings);
                        }
