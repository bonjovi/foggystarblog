			...
			<div class="post-content-wrapper">
				...
				<div class="right-side-area">
					...
					if ( 1 == $display_title ) { //phpcs:ignore
						?>
						<h1 class="bdp_post_title"><?php echo esc_attr( get_the_title() ); ?></h1>
						<?php
					}

					if ( 1 == $bdp_settings['display_author'] || 1 == $bdp_settings['display_date'] || 1 == $bdp_settings['display_comment'] ) { //phpcs:ignore
						?>
