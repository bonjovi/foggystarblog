			...
			>
				...
				if ( 1 == $bdp_settings['display_date'] ) { //phpcs:ignore
					...
					<div class="post_date">
						...
						<?php echo ( isset( $bdp_settings['dsiplay_date_from'] ) && 'modify' === $bdp_settings['dsiplay_date_from'] ) ? get_the_modified_time( 'd M' ) : get_the_time( 'd M' ); //phpcs:ignore ?>
					...
					$style = '';
				if ( 1 != $bdp_settings['display_author'] && 1 != $bdp_settings['display_category'] && 1 != $bdp_settings['display_comment'] ) { //phpcs:ignore
