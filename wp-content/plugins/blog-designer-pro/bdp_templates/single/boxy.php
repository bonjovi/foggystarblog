...
if ( ! function_exists( 'bdp_single_boxy_template' ) ) {
	...
	function bdp_single_boxy_template( $bdp_settings ) {
		...
		<div class="blog_wrap blog_template bdp_blog_template boxy">
			...
			<?php
			$class = '';
			if ( ( isset( $bdp_settings['display_date'] ) && 1 == $bdp_settings['display_date'] ) || ( isset( $bdp_settings['display_author'] ) && 1 == $bdp_settings['display_author'] ) || ( isset( $bdp_settings['display_comment'] ) && 1 == $bdp_settings['display_comment'] ) ) { //phpcs:ignore
				?>
				<div class="left_div">
				<?php
			...
			<div class="full_content_wrap <?php echo esc_attr( $class ); ?>">
				...
				<div class="post_summary_outer">
					...
					if ( 1 == $display_title ) { //phpcs:ignore
						?>
						<div class="blog_header"><h1 class="post-title"><?php echo esc_attr( get_the_title() ); ?></h1></div>
						<?php
					}
					if ( 'product' === $post_type ) {
