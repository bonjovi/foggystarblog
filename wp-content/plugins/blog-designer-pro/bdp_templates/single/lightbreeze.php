	...
	function bdp_single_lightbreeze_template( $bdp_settings ) {
		...
		<div class="blog_template bdp_blog_template box-template lightbreeze">
			...
			">
				...
				if ( 1 == $bdp_settings['display_date'] || 1 == $bdp_settings['display_author'] || 1 == $bdp_settings['display_tag'] || 1 == $bdp_settings['display_comment'] || 1 == $bdp_settings['display_comment'] ) { //phpcs:ignore
					?>
