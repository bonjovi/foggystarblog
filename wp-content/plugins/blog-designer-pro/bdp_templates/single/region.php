				...
				?>
					...
					if ( 1 == $display_author && 1 == $display_date ) { //phpcs:ignore
						...
						?>
							...
							<span class="<?php echo ( $author_link ) ? 'bdp-has-links' : 'bdp-no-links'; ?>"> <?php echo Bdp_Author::get_post_auhtors( $post->ID, $bdp_settings ); //phpcs:ignore ?> </span>
						<?php
						...
						<?php esc_html_e( 'By', 'blog-designer-pro' ); ?>
							...
							<?php echo Bdp_Author::get_post_auhtors(); //phpcs:ignore ?>
							</span>
						<?php
			...
			if ( in_array( $post_type, $bdp_all_post_type ) ) { //phpcs:ignore
				...
				if ( ( isset( $bdp_settings['display_category'] ) && 1 == $bdp_settings['display_category'] ) || ( isset( $bdp_settings['display_tag'] ) && 1 == $bdp_settings['display_tag'] ) ) { //phpcs:ignore
					...
					<div class="blog_footer footer_meta">
						...
						if ( 1 == $bdp_settings['display_tag'] ) { //phpcs:ignore
