		...
		<div class="blog_template bdp_blog_template elina-post-wrapper">
			...
			<div class="post-content-area">
                ...
                if ( in_array( $post_type, $bdp_all_post_type ) ) { //phpcs:ignore
					...
					if ( '' != $bdp_tax_cat && isset( $bdp_settings[ 'display_taxonomy_' . $bdp_tax_cat ] ) && $bdp_settings[ 'display_taxonomy_' . $bdp_tax_cat ] == 1 ) { //phpcs:ignore
				...
				$display_date    = ( isset( $bdp_settings['display_date'] ) && 1 == $bdp_settings['display_date'] ) ? $bdp_settings['display_date'] : ''; //phpcs:ignore
				$display_author  = ( isset( $bdp_settings['display_author'] ) && 1 == $bdp_settings['display_author'] ) ? $bdp_settings['display_author'] : ''; //phpcs:ignore
				$display_comment = ( isset( $bdp_settings['display_comment'] ) && 1 == $bdp_settings['display_comment'] ) ? $bdp_settings['display_comment'] : ''; //phpcs:ignore
				if ( 1 == $display_author || 1 == $display_date || 1 == $display_comment ) { //phpcs:ignore
					?>
				...
				if ( in_array( $post_type, $bdp_all_post_type ) ) { //phpcs:ignore
					 $taxonomy_names = get_object_taxonomies( $post_type, 'objects' ); //phpcs:ignore
					...
					foreach ( $taxonomy_names as $taxonomy_single ) {
						...
						if ( isset( $bdp_settings[ 'display_taxonomy_' . $taxonomy ] ) && 1 == $bdp_settings[ 'display_taxonomy_' . $taxonomy ] ) { //phpcs:ignore
							...
							$taxonomy_link        = ( isset( $bdp_settings[ 'disable_link_taxonomy_' . $taxonomy ] ) && $bdp_settings[ 'disable_link_taxonomy_' . $taxonomy ] == 1 ) ? false : true; //phpcs:ignore
