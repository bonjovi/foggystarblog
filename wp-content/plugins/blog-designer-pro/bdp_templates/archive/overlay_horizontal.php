						...
						<div class="photo post-image">
							...
							if ( has_post_thumbnail() ) {
								...
								<a href="<?php echo esc_url( get_permalink( $post->ID ) ); ?>">
									...
									$resize_image = Bdp_Utility::image_resize( $url, $width, $height, true, get_post_thumbnail_id() );
									echo '<img src="' . esc_attr( $resize_image['url'] ) . '" width="' . esc_attr( $resize_image['width'] ) . '" height="' . esc_attr( $resize_image['height'] ) . '" title="' . esc_attr( $post->post_title ) . '" alt="' . esc_attr( $post->post_title ) . '" />'
									?>
								</a>
								<?php
								...
								<a href="<?php echo esc_url( get_permalink( $post->ID ) ); ?>">
									...
									$width        = isset( $bdp_settings['item_width'] ) ? $bdp_settings['item_width'] : 400;
									$height       = isset( $bdp_settings['item_height'] ) ? $bdp_settings['item_height'] : 570;
									$resize_image = Bdp_Utility::image_resize( $url, $width, $height, true, $bdp_settings['bdp_default_image_id'] );
									echo '<img src="' . esc_attr( $resize_image['url'] ) . '" width="' . esc_attr( $resize_image['width'] ) . '" height="' . esc_attr( $resize_image['height'] ) . '" title="' . esc_attr( $post->post_title ) . '" alt="' . esc_attr( $post->post_title ) . '" />';
									?>
								</a>
								<?php
