...
if ( ! function_exists( 'bdp_archive_lightbreeze_template' ) ) {
	...
	function bdp_archive_lightbreeze_template( $bdp_settings, $alterclass ) {
		...
		if ( 'product' !== $post_type && isset( $bdp_settings['display_category'] ) && 0 == $bdp_settings['display_category'] ) { //phpcs:ignore
		...
		">
			...
			">
				...
				<?php
				if ( 1 == $bdp_settings['display_date'] || 1 == $bdp_settings['display_postlike'] || 1 == $bdp_settings['display_tag'] || 1 == $bdp_settings['display_author'] || 1 == $bdp_settings['display_category'] || 1 == $bdp_settings['display_comment_count'] ) {//phpcs:ignore
					?>
