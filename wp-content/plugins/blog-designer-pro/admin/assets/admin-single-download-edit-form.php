...
if ( isset( $_GET['page'] ) && 'single_edd_download' === $_GET['page'] ) { //phpcs:ignore
...
<div class="wrap">
			...
			<div class="postbox-container bd-settings-wrappers bd_poststuff">
				...
				<div class="bd-menu-setting">
					...
					if ( Bdp_Posts::postbox_classes( 'bdpsinglegeneral', $page ) ) {
						...
						$bdpsingleeddsetting_class      = 'class="bd-active-tab"';
						$bdpsingleeddsetting_class_show = 'style="display: block;"';
					...
					<ul class="bd-setting-handle">
						...
						<li data-show="bdpsingleeddsetting" <?php echo $bdpsingleeddsetting_class; //phpcs:ignore ?>>
						...
						<ul class="bdp-settings bdp-lineheight">
									...
									$template_color_preset = array(
										...
										'brit_co'          => array(
											...
											'brit_co_bronzetone' => array(
												...
												'preset_value' => 'template_bgcolor:#ffffff,template_ftcolor:#555555,template_fthovercolor:#67704E,template_titlecolor:#414C22,related_title_color:#414C22,template_contentcolor:#666666,firstletter_contentcolor:#666666,bdp_edd_price_color:#555555,bdp_edd_addtocart_textcolor:#ffffff,bdp_edd_addtocart_backgroundcolor:#414C22,bdp_edd_addtocart_text_hover_color:#ffffff,bdp_edd_addtocart_hover_backgroundcolor:#67704E',
											...
											'brit_co_fun_green' => array(
												'preset_name' => esc_html__( 'Fun Green', 'blog-designer-pro' ),
												'preset_value' => 'template_bgcolor:#EEF4F1,template_ftcolor:#555555,template_fthovercolor:#3E8563,template_titlecolor:#0E663C,related_title_color:#0E663C,template_contentcolor:#666666,firstletter_contentcolor:#666666,bdp_edd_price_color:#555555,bdp_edd_addtocart_textcolor:#ffffff,bdp_edd_addtocart_backgroundcolor:#0E663C,bdp_edd_addtocart_text_hover_color:#ffffff,bdp_edd_addtocart_hover_backgroundcolor:#3E8563',
										...
										'brite'            => array(
											...
											'brite_mandalay' => array(
												'preset_name' => esc_html__( 'Mandalay', 'blog-designer-pro' ),
												'preset_value' => 'template_ftcolor:#555555,template_fthovercolor:#C18F55,winter_category_color:#C18F55,template_titlecolor:#B1732A,related_title_color:#B1732A,template_contentcolor:#999999,firstletter_contentcolor:#999999,bdp_edd_price_color:#555555,bdp_edd_addtocart_textcolor:#ffffff,bdp_edd_addtocart_backgroundcolor:#B1732A,bdp_edd_addtocart_text_hover_color:#ffffff,bdp_edd_addtocart_hover_backgroundcolor:#C18F55',
												'display_value' => '#B1732A,#C18F55,#555555,#999999',
											),
											'brite_bronzetone' => array(
												'preset_name' => esc_html__( 'Bronzetone', 'blog-designer-pro' ),
												'preset_value' => 'template_ftcolor:#555555,template_fthovercolor:#67704E,winter_category_color:#67704E,template_titlecolor:#414C22,related_title_color:#414C22,template_contentcolor:#999999,firstletter_contentcolor:#999999,bdp_edd_price_color:#555555,bdp_edd_addtocart_textcolor:#ffffff,bdp_edd_addtocart_backgroundcolor:#414C22,bdp_edd_addtocart_text_hover_color:#ffffff,bdp_edd_addtocart_hover_backgroundcolor:#67704E',
												'display_value' => '#414C22,#67704E,#555555,#999999',
											),
											'brite_red_violet' => array(
												'preset_name' => esc_html__( 'Red Violet', 'blog-designer-pro' ),
												'preset_value' => 'template_ftcolor:#555555,template_fthovercolor:#C44C91,winter_category_color:#C44C91,template_titlecolor:#B51F76,related_title_color:#B51F76,template_contentcolor:#999999,firstletter_contentcolor:#999999,bdp_edd_price_color:#555555,bdp_edd_addtocart_textcolor:#ffffff,bdp_edd_addtocart_backgroundcolor:#B51F76,bdp_edd_addtocart_text_hover_color:#ffffff,bdp_edd_addtocart_hover_backgroundcolor:#C44C91',
										...
										'cool_horizontal'  => array(
											...
											'cool_horizontal_blue' => array(
												...
												'preset_value' => 'template_color:#6C71C3,template_ftcolor:#666666,template_fthovercolor:#333333,template_titlecolor:#6C71C3,related_title_color:#6C71C3,template_contentcolor:#444444,firstletter_contentcolor:#444444,bdp_edd_price_color:#666666,bdp_edd_addtocart_textcolor:#ffffff,bdp_edd_addtocart_backgroundcolor:#6C71C3,bdp_edd_addtocart_text_hover_color:#ffffff,bdp_edd_addtocart_hover_backgroundcolor:#666666',
												'display_value' => '#6C71C3,#666666,#6C71C3,#444444',
											),
											'cool_horizontal_java' => array(
												'preset_name' => esc_html__( 'Java', 'blog-designer-pro' ),
												'preset_value' => 'template_color:#29A198,template_ftcolor:#666666,template_fthovercolor:#333333,template_titlecolor:#29A198,related_title_color:#29A198,template_contentcolor:#444444,firstletter_contentcolor:#444444,bdp_edd_price_color:#666666,bdp_edd_addtocart_textcolor:#ffffff,bdp_edd_addtocart_backgroundcolor:#29A198,bdp_edd_addtocart_text_hover_color:#ffffff,bdp_edd_addtocart_hover_backgroundcolor:#666666',
											...
											'cool_horizontal_curious_blue' => array(
												...
												'preset_value' => 'template_color:#268BD3,template_ftcolor:#666666,template_fthovercolor:#333333,template_titlecolor:#268BD3,related_title_color:#268BD3,template_contentcolor:#444444,firstletter_contentcolor:#444444,bdp_edd_price_color:#666666,bdp_edd_addtocart_textcolor:#ffffff,bdp_edd_addtocart_backgroundcolor:#268BD3,bdp_edd_addtocart_text_hover_color:#ffffff,bdp_edd_addtocart_hover_backgroundcolor:#666666',
												'display_value' => '#268BD3,#666666,#268BD3,#444444',
											),
											'cool_horizontal_olive' => array(
												'preset_name' => esc_html__( 'Olive', 'blog-designer-pro' ),
												'preset_value' => 'template_color:#869901,template_ftcolor:#666666,template_fthovercolor:#333333,template_titlecolor:#869901,related_title_color:#869901,template_contentcolor:#444444,firstletter_contentcolor:#444444,bdp_edd_price_color:#666666,bdp_edd_addtocart_textcolor:#ffffff,bdp_edd_addtocart_backgroundcolor:#869901,bdp_edd_addtocart_text_hover_color:#ffffff,bdp_edd_addtocart_hover_backgroundcolor:#666666',
										...
										'elina'            => array(
											...
											'elina_bronzetone' => array(
												'preset_name' => esc_html__( 'Bronzetone', 'blog-designer-pro' ),
												'preset_value' => 'template_bgcolor:#ffffff,template_ftcolor:#333333,template_fthovercolor:#67704E,template_titlecolor:#414C22,related_title_color:#414C22,template_contentcolor:#555555,firstletter_contentcolor:#555555,bdp_edd_price_color:#555555,bdp_edd_addtocart_textcolor:#ffffff,bdp_edd_addtocart_backgroundcolor:#414C22,bdp_edd_addtocart_text_hover_color:#ffffff,bdp_edd_addtocart_hover_backgroundcolor:#67704E',
												'display_value' => '#414C22,#67704E,#333333,#555555',
											),
											'elina_buttercup' => array(
												'preset_name' => esc_html__( 'Buttercup', 'blog-designer-pro' ),
												'preset_value' => 'template_bgcolor:#FDF7F1,template_ftcolor:#333333,template_fthovercolor:#E5A452,template_titlecolor:#DF8D27,related_title_color:#DF8D27,template_contentcolor:#555555,firstletter_contentcolor:#555555,bdp_edd_price_color:#555555,bdp_edd_addtocart_textcolor:#ffffff,bdp_edd_addtocart_backgroundcolor:#DF8D27,bdp_edd_addtocart_text_hover_color:#ffffff,bdp_edd_addtocart_hover_backgroundcolor:#E5A452',
										...
										'evolution'        => array(
											...
											'evolution_alizarin' => array(
												'preset_name' => esc_html__( 'Alizarin', 'blog-designer-pro' ),
												'preset_value' => 'template_bgcolor:#FCE1E4,template_ftcolor:#333333,template_fthovercolor:#ED4961,template_titlecolor:#E81B3A,related_title_color:#E81B3A,template_contentcolor:#555555,firstletter_contentcolor:#555555,bdp_edd_price_color:#555555,bdp_edd_addtocart_textcolor:#ffffff,bdp_edd_addtocart_backgroundcolor:#E81B3A,bdp_edd_addtocart_text_hover_color:#ffffff,bdp_edd_addtocart_hover_backgroundcolor:#ED4961',
										...
										'explore'          => array(
											'explore_default' => array(
												'preset_name' => esc_html__( 'Default', 'blog-designer-pro' ),
												'preset_value' => 'template_bgcolor:#ffffff,template_ftcolor:#333333,template_fthovercolor:#44545D,template_titlecolor:#152934,related_title_color:#152934,template_contentcolor:#555555,firstletter_contentcolor:#555555,bdp_edd_price_color:#555555,bdp_edd_addtocart_textcolor:#ffffff,bdp_edd_addtocart_backgroundcolor:#152934,bdp_edd_addtocart_text_hover_color:#ffffff,bdp_edd_addtocart_hover_backgroundcolor:#44545D',
												'display_value' => '#152934,#44545D,#333333,#555555',
											),
											'explore_lemon_ginger' => array(
												'preset_name' => esc_html__( 'Lemon Ginger', 'blog-designer-pro' ),
												'preset_value' => 'template_bgcolor:#ffffff,template_ftcolor:#333333,template_fthovercolor:#A39D5A,template_titlecolor:#8C8431,related_title_color:#8C8431,template_contentcolor:#555555,firstletter_contentcolor:#555555,bdp_edd_price_color:#555555,bdp_edd_addtocart_textcolor:#ffffff,bdp_edd_addtocart_backgroundcolor:#8C8431,bdp_edd_addtocart_text_hover_color:#ffffff,bdp_edd_addtocart_hover_backgroundcolor:#A39D5A',
											...
											'explore_catalina_blue' => array(
												...
												'preset_value' => 'template_bgcolor:#F0F1F4,template_ftcolor:#333333,template_fthovercolor:#495F85,template_titlecolor:#1B3766,related_title_color:#1B3766,template_contentcolor:#555555,firstletter_contentcolor:#555555,bdp_edd_price_color:#555555,bdp_edd_addtocart_textcolor:#ffffff,bdp_edd_addtocart_backgroundcolor:#1B3766,bdp_edd_addtocart_text_hover_color:#ffffff,bdp_edd_addtocart_hover_backgroundcolor:#495F85',
												'display_value' => '#1B3766,#495F85,#333333,#555555',
											),
											'explore_red_violet' => array(
												'preset_name' => esc_html__( 'Red Violet', 'blog-designer-pro' ),
												'preset_value' => 'template_bgcolor:#FAF0F6,template_ftcolor:#333333,template_fthovercolor:#C44C91,template_titlecolor:#B51F76,related_title_color:#B51F76,template_contentcolor:#555555,firstletter_contentcolor:#555555,bdp_edd_price_color:#555555,bdp_edd_addtocart_textcolor:#ffffff,bdp_edd_addtocart_backgroundcolor:#B51F76,bdp_edd_addtocart_text_hover_color:#ffffff,bdp_edd_addtocart_hover_backgroundcolor:#C44C91',
												'display_value' => '#B51F76,#C44C91,#333333,#555555',
											),
											'explore_blackberry' => array(
												'preset_name' => esc_html__( 'Blackberry', 'blog-designer-pro' ),
												'preset_value' => 'template_bgcolor:#F3F0F1,template_ftcolor:#333333,template_fthovercolor:#6D4657,template_titlecolor:#49182D,related_title_color:#49182D,template_contentcolor:#555555,firstletter_contentcolor:#555555,bdp_edd_price_color:#555555,bdp_edd_addtocart_textcolor:#ffffff,bdp_edd_addtocart_backgroundcolor:#49182D,bdp_edd_addtocart_text_hover_color:#ffffff,bdp_edd_addtocart_hover_backgroundcolor:#6D4657',
										...
										'masonry_timeline' => array(
											...
											'masonry_timeline_peru_tan' => array(
												'preset_name' => esc_html__( 'Peru Tan', 'blog-designer-pro' ),
												'preset_value' => 'template_bgcolor:#ffffff,template_ftcolor:#333333,template_fthovercolor:#916748,template_titlecolor:#75411A,related_title_color:#75411A,template_contentcolor:#555555,firstletter_contentcolor:#555555,bdp_edd_price_color:#555555,bdp_edd_addtocart_textcolor:#ffffff,bdp_edd_addtocart_backgroundcolor:#75411A,bdp_edd_addtocart_text_hover_color:#ffffff,bdp_edd_addtocart_hover_backgroundcolor:#916748',
										...
										'media-grid'       => array(
											...
											'media-grid_bronzetone' => array(
												'preset_name' => esc_html__( 'Bronzetone', 'blog-designer-pro' ),
												'preset_value' => 'template_color:#67704E,template_ftcolor:#333333,template_fthovercolor:#67704E,template_titlecolor:#414C22,related_title_color:#414C22,template_contentcolor:#555555,firstletter_contentcolor:#555555,bdp_edd_price_color:#555555,bdp_edd_addtocart_textcolor:#ffffff,bdp_edd_addtocart_backgroundcolor:#414C22,bdp_edd_addtocart_text_hover_color:#ffffff,bdp_edd_addtocart_hover_backgroundcolor:#67704E',
												'display_value' => '#414C22,#67704E,#333333,#555555',
											),
										...
										'navia'            => array(
											'navia_default' => array(
												'preset_name' => esc_html__( 'Default', 'blog-designer-pro' ),
												'preset_value' => 'template_ftcolor:#0E7699,template_fthovercolor:#555555,template_titlecolor:#222222,related_title_color:#222222,template_contentcolor:#999999,firstletter_contentcolor:#999999,bdp_edd_price_color:#555555,bdp_edd_addtocart_textcolor:#ffffff,bdp_edd_addtocart_backgroundcolor:#0E7699,bdp_edd_addtocart_text_hover_color:#ffffff,bdp_edd_addtocart_hover_backgroundcolor:#222222',
											...
											'navia_bronzetone' => array(
												'preset_name' => esc_html__( 'Bronzetone', 'blog-designer-pro' ),
												'preset_value' => 'template_ftcolor:#555555,template_fthovercolor:#67704E,template_titlecolor:#414C22,related_title_color:#414C22,template_contentcolor:#999999,firstletter_contentcolor:#999999,bdp_edd_price_color:#555555,bdp_edd_addtocart_textcolor:#ffffff,bdp_edd_addtocart_backgroundcolor:#414C22,bdp_edd_addtocart_text_hover_color:#ffffff,bdp_edd_addtocart_hover_backgroundcolor:#67704E',
												'display_value' => '#414C22,#67704E,#555555,#999999',
											),
											...
											'navia_earls_green' => array(
												'preset_name' => esc_html__( 'Earls Green', 'blog-designer-pro' ),
												'preset_value' => 'template_ftcolor:#555555,template_fthovercolor:#CEBF59,template_titlecolor:#C2AF2F,related_title_color:#C2AF2F,template_contentcolor:#999999,firstletter_contentcolor:#999999,bdp_edd_price_color:#555555,bdp_edd_addtocart_textcolor:#ffffff,bdp_edd_addtocart_backgroundcolor:#C2AF2F,bdp_edd_addtocart_text_hover_color:#ffffff,bdp_edd_addtocart_hover_backgroundcolor:#CEBF59',
												'display_value' => '#C2AF2F,#CEBF59,#555555,#999999',
											),
										),
										'news'             => array(
											...
											'news_alizarin' => array(
												'preset_name' => esc_html__( 'Alizarin', 'blog-designer-pro' ),
												'preset_value' => 'template_ftcolor:#555555,template_fthovercolor:#ED4961,template_titlecolor:#E81B3A,related_title_color:#E81B3A,template_contentcolor:#999999,firstletter_contentcolor:#999999,bdp_edd_price_color:#555555,bdp_edd_addtocart_textcolor:#ffffff,bdp_edd_addtocart_backgroundcolor:#E81B3A,bdp_edd_addtocart_text_hover_color:#ffffff,bdp_edd_addtocart_hover_backgroundcolor:#ED4961',
										...
										'offer_blog'       => array(
											'offer_blog_default' => array(
												'preset_name' => esc_html__( 'Default', 'blog-designer-pro' ),
												'preset_value' => 'template_bgcolor:#ffffff,template_ftcolor:#0E7699,template_fthovercolor:#333333,template_titlecolor:#222222,related_title_color:#222222,template_contentcolor:#555555,firstletter_contentcolor:#555555,bdp_edd_price_color:#555555,bdp_edd_addtocart_textcolor:#ffffff,bdp_edd_addtocart_backgroundcolor:#0E7699,bdp_edd_addtocart_text_hover_color:#ffffff,bdp_edd_addtocart_hover_backgroundcolor:#222222',
												'display_value' => '#0E7699,#222222,#333333,#555555',
											),
											'offer_blog_earls_green' => array(
												'preset_name' => esc_html__( 'Earls Green', 'blog-designer-pro' ),
												'preset_value' => 'template_bgcolor:#ffffff,template_ftcolor:#333333,template_fthovercolor:#CEBF59,template_titlecolor:#C2AF2F,related_title_color:#C2AF2F,template_contentcolor:#555555,firstletter_contentcolor:#555555,bdp_edd_price_color:#555555,bdp_edd_addtocart_textcolor:#ffffff,bdp_edd_addtocart_backgroundcolor:#C2AF2F,bdp_edd_addtocart_text_hover_color:#ffffff,bdp_edd_addtocart_hover_backgroundcolor:#CEBF59',
										...
										'region'           => array(
											...
											'region_alizarin' => array(
												'preset_name' => esc_html__( 'Alizarin', 'blog-designer-pro' ),
												'preset_value' => 'template_ftcolor:#333333,template_fthovercolor:#ED4961,template_titlecolor:#E81B3A,related_title_color:#E81B3A,template_contentcolor:#555555,firstletter_contentcolor:#555555,bdp_edd_price_color:#555555,bdp_edd_addtocart_textcolor:#ffffff,bdp_edd_addtocart_backgroundcolor:#E81B3A,bdp_edd_addtocart_text_hover_color:#ffffff,bdp_edd_addtocart_hover_backgroundcolor:#ED4961',
												'display_value' => '#E81B3A,#ED4961,#333333,#555555',
											),
											'region_lemon_ginger' => array(
												'preset_name' => esc_html__( 'Lemon Ginger', 'blog-designer-pro' ),
												'preset_value' => 'template_ftcolor:#333333,template_fthovercolor:#A39D5A,template_titlecolor:#8C8431,related_title_color:#8C8431,template_contentcolor:#555555,firstletter_contentcolor:#555555,bdp_edd_price_color:#555555,bdp_edd_addtocart_textcolor:#ffffff,bdp_edd_addtocart_backgroundcolor:#8C8431,bdp_edd_addtocart_text_hover_color:#ffffff,bdp_edd_addtocart_hover_backgroundcolor:#A39D5A',
												'display_value' => '#8C8431,#A39D5A,#333333,#555555',
											),
										...
										'roctangle'        => array(
											'roctangle_default' => array(
												'preset_name' => esc_html__( 'Default', 'blog-designer-pro' ),
												'preset_value' => 'template_bgcolor:#ffffff,template_color:#f18293,template_ftcolor:#666666,template_fthovercolor:#444444,template_titlecolor:#222222,template_contentcolor:#444444,firstletter_contentcolor:#444444,bdp_edd_price_color:#666666,bdp_edd_addtocart_textcolor:#ffffff,bdp_edd_addtocart_backgroundcolor:#f18293,bdp_edd_addtocart_text_hover_color:#ffffff,bdp_edd_addtocart_hover_backgroundcolor:#222222',
												'display_value' => '#f18293,#222222,#444444,#666666',
											),
											'roctangle_sky_blue' => array(
												'preset_name' => esc_html__( 'Sky Blue', 'blog-designer-pro' ),
												'preset_value' => 'template_bgcolor:#ffffff,template_color:#92E2FD,template_ftcolor:#666666,template_fthovercolor:#444444,template_titlecolor:#222222,template_contentcolor:#444444,firstletter_contentcolor:#444444,bdp_edd_price_color:#666666,bdp_edd_addtocart_textcolor:#ffffff,bdp_edd_addtocart_backgroundcolor:#92E2FD,bdp_edd_addtocart_text_hover_color:#ffffff,bdp_edd_addtocart_hover_backgroundcolor:#222222',
												'display_value' => '#92E2FD,#222222,#444444,#666666',
											),
											'roctangle_lite_green' => array(
												'preset_name' => esc_html__( 'Lite Green', 'blog-designer-pro' ),
												'preset_value' => 'template_bgcolor:#ffffff,template_color:#0ef58d,template_ftcolor:#666666,template_fthovercolor:#444444,template_titlecolor:#222222,template_contentcolor:#444444,firstletter_contentcolor:#444444,bdp_edd_price_color:#666666,bdp_edd_addtocart_textcolor:#ffffff,bdp_edd_addtocart_backgroundcolor:#0ef58d,bdp_edd_addtocart_text_hover_color:#ffffff,bdp_edd_addtocart_hover_backgroundcolor:#222222',
										...
										'winter'           => array(
											...
											'winter_buttercup' => array(
												'preset_name' => esc_html__( 'Buttercup', 'blog-designer-pro' ),
												'preset_value' => 'winter_category_color:#E5A452,template_ftcolor:#555555,template_fthovercolor:#E5A452,template_titlecolor:#DF8D27,related_title_color:#DF8D27,template_contentcolor:#999999,firstletter_contentcolor:#999999,bdp_edd_price_color:#555555,bdp_edd_addtocart_textcolor:#ffffff,bdp_edd_addtocart_backgroundcolor:#DF8D27,bdp_edd_addtocart_text_hover_color:#ffffff,bdp_edd_addtocart_hover_backgroundcolor:#E5A452',
												'display_value' => '#DF8D27,#E5A452,#555555,#999999',
											),
											'winter_alizarin' => array(
												'preset_name' => esc_html__( 'Alizarin', 'blog-designer-pro' ),
												'preset_value' => 'winter_category_color:#EE4861,template_ftcolor:#555555,template_fthovercolor:#EE4861,template_titlecolor:#EA1A3A,related_title_color:#EA1A3A,template_contentcolor:#999999,firstletter_contentcolor:#999999,bdp_edd_price_color:#555555,bdp_edd_addtocart_textcolor:#ffffff,bdp_edd_addtocart_backgroundcolor:#EA1A3A,bdp_edd_addtocart_text_hover_color:#ffffff,bdp_edd_addtocart_hover_backgroundcolor:#EE4861',
										...
										'fairy'            => array(
											...
											'fairy_scampi' => array(
												...
												'preset_value' => 'template_bgcolor:#ECECF0,template_ftcolor:#393848,template_fthovercolor:#6F6E8D,template_titlecolor:#0F0E13,related_title_color:#0F0E13,template_contentcolor:#18171E,firstletter_contentcolor:#18171E,bdp_edd_price_color:#18171E,bdp_edd_addtocart_textcolor:#ffffff,bdp_edd_addtocart_backgroundcolor:#6F6E8D,bdp_edd_addtocart_text_hover_color:#ffffff,bdp_edd_addtocart_hover_backgroundcolor:#18171E',
												'display_value' => '#ECECF0 ,#6F6E8D,#18171E,#0F0E13',
											),
											'fairy_crusoe' => array(
												'preset_name' => esc_html__( 'Crusoe', 'blog-designer-pro' ),
												'preset_value' => 'template_bgcolor:#DFEAE1,template_ftcolor:#083511,template_fthovercolor:#0F6620,template_titlecolor:#020E05,related_title_color:#020E05,template_contentcolor:#041B09,firstletter_contentcolor:#041B09,bdp_edd_price_color:#041B09,bdp_edd_addtocart_textcolor:#ffffff,bdp_edd_addtocart_backgroundcolor:#0F6620,bdp_edd_addtocart_text_hover_color:#ffffff,bdp_edd_addtocart_hover_backgroundcolor:#041B09',
										...
										'clicky'           => array(
											...
											'clicky_portage' => array(
												...
												'preset_value' => 'template_bgcolor:#ffffff,template_ftcolor:#C1C5ED,template_fthovercolor:#2A2B3C,winter_category_color:#2A2B3C,template_titlecolor:#2A2B3C,related_title_color:#2A2B3C,template_contentcolor:#9DA5E4,firstletter_contentcolor:#9DA5E4,bdp_edd_price_color:#555555,bdp_edd_addtocart_textcolor:#ffffff,bdp_edd_addtocart_backgroundcolor:#9DA5E4,bdp_edd_addtocart_text_hover_color:#ffffff,bdp_edd_addtocart_hover_backgroundcolor:#2A2B3C',
												'display_value' => '#ffffff ,#C1C5ED,#9DA5E4,#2A2B3C',
											),
											'clicky_emerald' => array(
												'preset_name' => esc_html__( 'Emerald', 'blog-designer-pro' ),
												'preset_value' => 'template_bgcolor:#E4FCEA,template_ftcolor:#229541,template_fthovercolor:#0B3116,winter_category_color:#0B3116,template_titlecolor:#0B3116,related_title_color:#0B3116,template_contentcolor:#165F2A,firstletter_contentcolor:#165F2A,bdp_edd_price_color:#0B3116,bdp_edd_addtocart_textcolor:#ffffff,bdp_edd_addtocart_backgroundcolor:#165F2A,bdp_edd_addtocart_text_hover_color:#ffffff,bdp_edd_addtocart_hover_backgroundcolor:#0B3116',
										...
										'miracle'          => array(
											'miracle_default' => array(
												'preset_name' => esc_html__( 'Default', 'blog-designer-pro' ),
												'preset_value' => 'template_bgcolor:#ffffff,template_ftcolor:#62bf7c,template_fthovercolor:#686868,template_titlecolor:#353535,related_title_color:#353535,template_contentcolor:#252525,firstletter_contentcolor:#252525,bdp_edd_price_color:#252525,bdp_edd_addtocart_textcolor:#ffffff,bdp_edd_addtocart_backgroundcolor:#62bf7c,bdp_edd_addtocart_text_hover_color:#ffffff,bdp_edd_addtocart_hover_backgroundcolor:#353535',
										...
										'neaty_block'      => array(
											...
											'neaty_block_roof_terracotta' => array(
												...
												'preset_value' => 'template_color:#B06F6D,template_bgcolor:#ffffff,template_bghovercolor:#F1E7E7,template_ftcolor:#555555,template_fthovercolor:#B06F6D,template_titlecolor:#9C4B48,template_titlehovercolor:#B06F6D,template_contentcolor:#999999,bdp_edd_price_color:#999999,bdp_edd_addtocart_textcolor:#ffffff,bdp_edd_addtocart_backgroundcolor:#B06F6D,bdp_edd_addtocart_text_hover_color:#ffffff,bdp_edd_addtocart_hover_backgroundcolor:#555555',
												'display_value' => '#9C4B48,#B06F6D,#555555,#999999',
											),
											'neaty_block_bronzetone' => array(
												'preset_name' => esc_html__( 'Bronzetone', 'blog-designer-pro' ),
												'preset_value' => 'template_bgcolor:#ffffff,template_ftcolor:#555555,template_fthovercolor:#67704E,template_titlecolor:#414C22,template_titlehovercolor:#67704E,template_titlebackcolor:#ffffff,template_contentcolor:#999999,bdp_edd_price_color:#555555,bdp_edd_addtocart_textcolor:#ffffff,bdp_edd_addtocart_backgroundcolor:#414C22,bdp_edd_addtocart_text_hover_color:#ffffff,bdp_edd_addtocart_hover_backgroundcolor:#999999',
												'display_value' => '#414C22,#67704E,#555555,#999999',
											),
											'offer_yonder' => array(
												'preset_name' => esc_html__( 'Yonder', 'blog-designer-pro' ),
												'preset_value' => 'template_bgcolor:#F3F5FA,template_ftcolor:#555555,template_fthovercolor:#8BA3CE,template_titlecolor:#6E8CC2,template_titlehovercolor:#8BA3CE,template_titlebackcolor:#F3F5FA,template_contentcolor:#666666,bdp_edd_price_color:#555555,bdp_edd_addtocart_textcolor:#ffffff,bdp_edd_addtocart_backgroundcolor:#6E8CC2,bdp_edd_addtocart_text_hover_color:#ffffff,bdp_edd_addtocart_hover_backgroundcolor:#666666',
										...
										'soft_block'       => array(
											...
											'soft_block_burgundy' => array(
												'preset_name' => esc_html__( 'Burgundy', 'blog-designer-pro' ),
												'preset_value' => 'template_bgcolor:#FAF6F7,template_ftcolor:#6C0124,template_fthovercolor:#2C010E,template_titlecolor:#FAF6F7,template_titlehovercolor:#6C0124,template_contentcolor:#FAF6F7,bdp_edd_price_color:#0E0105,bdp_edd_addtocart_textcolor:#ffffff,bdp_edd_addtocart_backgroundcolor:#6C0124,bdp_edd_addtocart_text_hover_color:#FAF6F7,bdp_edd_addtocart_hover_backgroundcolor:#0E0105',
												'display_value' => '#FAF6F7,#6C0124,#0E0105,#1C0109',
											),
											'soft_block_hillary' => array(
												'preset_name' => esc_html__( 'Hillary', 'blog-designer-pro' ),
												'preset_value' => 'template_bgcolor:#FCFBFA,template_ftcolor:#A49E77,template_fthovercolor:#434131,template_titlecolor:#FCFBFA,template_titlehovercolor:#A49E77,template_contentcolor:#FCFBFA,bdp_edd_price_color:#161610,bdp_edd_addtocart_textcolor:#ffffff,bdp_edd_addtocart_backgroundcolor:#A49E77,bdp_edd_addtocart_text_hover_color:#FCFBFA,bdp_edd_addtocart_hover_backgroundcolor:#161610',
												'display_value' => '#FCFBFA,#A49E77,#161610,#2B2A1F',
											),
											'soft_block_amaranth' => array(
												'preset_name' => esc_html__( 'Amaranth', 'blog-designer-pro' ),
												'preset_value' => 'template_bgcolor:#FDF9FA,template_ftcolor:#DE364A,template_fthovercolor:#491218,template_titlecolor:#FDF9FA,template_titlehovercolor:#DE364A,template_contentcolor:#FDF9FA,bdp_edd_price_color:#1E070A,bdp_edd_addtocart_textcolor:#ffffff,bdp_edd_addtocart_backgroundcolor:#DE364A,bdp_edd_addtocart_text_hover_color:#FDF9FA,bdp_edd_addtocart_hover_backgroundcolor:#1E070A',
												'display_value' => '#FDF9FA,#DE364A,#1E070A,#2E0B0F',
											),
											'soft_block_manatee' => array(
												'preset_name' => esc_html__( 'Manatee', 'blog-designer-pro' ),
												'preset_value' => 'template_bgcolor:#FCFCFD,template_ftcolor:#9699A7,template_fthovercolor:#3E3E45,template_titlecolor:#FCFCFD,template_titlehovercolor:#9699A7,template_titlebackcolor:#FCFCFD,template_contentcolor:#FCFCFD,bdp_edd_price_color:#151516,bdp_edd_addtocart_textcolor:#ffffff,bdp_edd_addtocart_backgroundcolor:#9699A7,bdp_edd_addtocart_text_hover_color:#FCFCFD,bdp_edd_addtocart_hover_backgroundcolor:#151516',
												'display_value' => '#FCFCFD,#9699A7,#151516,#28282C',
											),
										),
										'schedule'         => array(
											...
											'schedule_mariner' => array(
												...
												'preset_value' => 'template_color:#465BAC,template_bgcolor:#EAEDF6,template_ftcolor:#465BAC,template_fthovercolor:#ffffff,template_titlecolor:#465BAC,template_titlehovercolor:#484848,template_titlebackcolor:#eaedf6,template_contentcolor:#7b7b7b,bdp_edd_price_color:#484848,bdp_edd_addtocart_textcolor:#ffffff,bdp_edd_addtocart_backgroundcolor:#465BAC,bdp_edd_addtocart_text_hover_color:#ffffff,bdp_edd_addtocart_hover_backgroundcolor:#484848,winter_category_color:#465BAC',
												'display_value' => '#465BAC,#EAEDF6,#465BAC,#484848',
											),
											'schedule_flamenco' => array(
												'preset_name' => esc_html__( 'Flamenco', 'blog-designer-pro' ),
												'preset_value' => 'template_color:#683C6F,template_bgcolor:#FFF3ED,template_ftcolor:#683C6F,template_fthovercolor:#ffffff,template_titlecolor:#683C6F,template_titlehovercolor:#484848,template_titlebackcolor:#FFF3ED,template_contentcolor:#7b7b7bfffff,,bdp_edd_price_color:#484848
											...
											'schedule_finch' => array(
												...
												'preset_value' => 'template_color:#75815B,template_bgcolor:#EFF0EB,template_ftcolor:#75815B,template_fthovercolor:#ffffff,template_titlecolor:#75815B,template_titlehovercolor:#484848,template_titlebackcolor:#EFF0EB,template_contentcolor:#7b7b7b,bdp_edd_price_color:#484848,
							...
							<li class="override-single-design-li single_category_list_tr">
								...
								<div class="bdp-right single_download_category_list_tr">
									...
									$db_categories     = $wpdb->get_results( 'SELECT sub_categories FROM ' . $wpdb->prefix . 'bdp_single_ed_download WHERE single_download_template = "category"' ); //phpcs:ignore
							...
							<li class="override-single-design-li single_tag_list_tr">
								...
								<div class="bdp-right">
									...
									$db_tags       = $wpdb->get_results( 'SELECT sub_categories FROM ' . $wpdb->prefix . 'bdp_single_ed_download WHERE single_download_template = "tag"' ); //phpcs:ignore
									$db_tag_list   = array();
									if ( $db_tags ) {
							...
							<li class="override-single-design-li single_all_post_tr">
								...
								<div class="bdp-right single_all_download_tr">
									<span class="fas fa-question-circle bdp-tooltips-icon"><span class="bdp-tooltips"><?php esc_html_e( 'Select product from available posts for single product layout', 'blog-designer-pro' ); ?></span></span>
									<?php
									$template_posts = isset( $bdp_settings['template_posts'] ) ? $bdp_settings['template_posts'] : array();
									$db_posts       = $wpdb->get_results( 'SELECT single_download_id FROM ' . $wpdb->prefix . 'bdp_single_ed_download' ); //phpcs:ignore
									$db_posts_list  = array();
									if ( $db_posts ) {
										...
										<select data-placeholder="<?php esc_attr_e( 'Choose Products', 'blog-designer-pro' ); ?>" class="chosen-select" multiple style="width:220px;" name="template_posts[]" id="template_posts">
											...
											foreach ( $allposts as $single_download_id ) {
												...
												<option value="<?php echo esc_attr( $single_post->ID ); ?>"
													<?php
													if ( !empty($bdp_settings['template_posts']) && is_array($bdp_settings['template_posts']) && in_array( $single_post->ID, $bdp_settings['template_posts'] ) ) { //phpcs:ignore
														echo 'selected="selected"';
													}
													if ( !empty($final_posts) && is_array($final_posts) &&  in_array( $single_post->ID, $final_posts ) ) { //phpcs:ignore
														echo 'disabled="disabled"';
													}
													?>
												...
												?>
													<div class="bdp-typography-cover">
														<div class="bdp-typography-label">
															...
															<span class="fas fa-question-circle bdp-tooltips-icon"><span class="bdp-tooltips"><?php echo esc_html__( 'Show', 'blog-designer-pro' ) . ' ' . esc_attr( $taxonomy_name->label ) . ' ' . esc_html__( 'in single layout', 'blog-designer-pro' ); ?></span></span>
														</div>
														<div class="bdp-typography-content">
														<?php
				...
				<div id="bdpsinglemedia" class="postbox postbox-with-fw-options bdp-content-setting1" <?php echo $bdpmedia_class_show; //phpcs:ignore ?>>
					<div class="inside">
						...
						<li class="bdp_single_custom_media_selection">
								...
								<div class="bdp-right">
									<span class="fas fa-question-circle bdp-tooltips-icon"><span class="bdp-tooltips"><?php esc_html_e( 'Enable/Disable product thumbnail', 'blog-designer-pro' ); ?></span></span>
				...
				<div id="bdpsingleeddsetting" class="postbox postbox-with-fw-options" <?php echo $bdpsingleeddsetting_class_show; //phpcs:ignore ?>>
					<div class="inside">
						<ul class="bdp-settings bdp-lineheight">
							<li>
								<div class="bdp-left">
								...
								<div class="bdp-right">
									<span class="fas fa-question-circle bdp-tooltips-icon"><span class="bdp-tooltips"><?php esc_html_e( 'Enable/Disable product price', 'blog-designer-pro' ); ?></span></span>
									<?php
								...
								<ul>
									<li class="bdp_pricetext_tr">
										...
										<div class="bdp-right">
											...
											$bdp_edd_price_color = ( isset( $bdp_settings['bdp_edd_price_color'] ) && '' != $bdp_settings['bdp_edd_price_color'] ) ? $bdp_settings['bdp_edd_price_color'] : '#444444'; //phpcs:ignore
											?>
									...
									<li class="bdp_edd_pricetext_tr bdp_edd_pricetext_alignment_tr">
										...
										<div class="bdp-right">
											...
											<fieldset class="buttonset green" data-hide='1'>
												...
												<label id="bdp-options-button" for="bdp_edd_price_alignment_left"><?php esc_html_e( 'Left', 'blog-designer-pro' ); ?></label>
												...
												<label id="bdp-options-button" for="bdp_edd_price_alignment_center" class="bdp_edd_price_alignment_center"><?php esc_html_e( 'Center', 'blog-designer-pro' ); ?></label>
												...
												<label id="bdp-options-button" for="bdp_edd_price_alignment_right"><?php esc_html_e( 'Right', 'blog-designer-pro' ); ?></label>
											</fieldset>
										</div>
									</li>
									<li class="bdp_edd_pricetext_tr bdp_edd_pricetext_padding_setting_tr">
										...
										<div class="bdp-right bdp-border-cover">
											<span class="fas fa-question-circle bdp-tooltips-icon bdp-tooltips-icon-color"><span class="bdp-tooltips"><?php esc_html_e( 'Set price text padding', 'blog-designer-pro' ); ?></span></span>
									...
									<li class="bdp_edd_pricetext_tr bdp_edd_pricetext_typography_setting_tr">
										...
										<div class="bdp-typography-wrapper bdp-typography-wrapper1">
											<div class="bdp-typography-cover">
												...
												<div class="bdp-typography-content">
													<?php
													if ( isset( $bdp_settings['bdp_edd_pricefontface'] ) && '' != $bdp_settings['bdp_edd_pricefontface'] ) { //phpcs:ignore
														...
														<div class="select-cover">
															<select name="bdp_edd_pricefontface" id="bdp_edd_pricefontface">
																...
																foreach ( $font_family as $key => $value ) {
																	...
																	if ( '' != $bdp_edd_pricefontface && ( str_replace( '"', '', $bdp_edd_pricefontface ) == str_replace( '"', '', $value['label'] ) ) ) { //phpcs:ignore
																		echo ' selected';
																	}
																	echo '>' . esc_attr( $value['label'] ) . '</option>';
																	$cnt++;
											...
											<div class="bdp-typography-cover">
												...
												<div class="bdp-typography-content">
													<?php
													if ( isset( $bdp_settings['bdp_edd_pricefontsize'] ) && '' != $bdp_settings['bdp_edd_pricefontsize'] ) { //phpcs:ignore
														$bdp_edd_pricefontsize = $bdp_settings['bdp_edd_pricefontsize'];
													} else {
														$bdp_edd_pricefontsize = 14;
													}
													?>
													<div class="grid_col_space range_slider_fontsize" id="bdp_edd_pricefontsizeInput" ></div>
													<div class="slide_val"><span></span><input class="grid_col_space_val range-slider__value" name="bdp_edd_pricefontsize" id="bdp_edd_pricefontsize" value="<?php echo esc_attr( $bdp_edd_pricefontsize ); ?>" onkeypress="return isNumberKey(event)" /></div>
												</div>
											</div>
											...
											<div class="bdp-typography-label">
												...
												<span class="fas fa-question-circle bdp-tooltips-icon"><span class="bdp-tooltips"><?php esc_html_e( 'Display price text italic font style', 'blog-designer-pro' ); ?></span></span><?php $bdp_edd_price_font_italic = isset( $bdp_settings['bdp_edd_price_font_italic'] ) ? $bdp_settings['bdp_edd_price_font_italic'] : '0'; ?>
											</div>
											<div class="bdp-typography-content">
												<fieldset class="bdp-social-options bdp-display_author buttonset">
							...
							<li>
								...
								<div class="bdp-right">
									<span class="fas fa-question-circle bdp-tooltips-icon"><span class="bdp-tooltips"><?php esc_html_e( 'Enable/Disable purchase button', 'blog-designer-pro' ); ?></span></span>
									<?php
								...
								<li class="bdp_edd_cart_button_setting">
									...
									<ul>
										<li class="bdp_edd_add_to_cart_tr edd_cart_button_alignment">
											...
											<div class="bdp-right">
												...
												<fieldset class="buttonset green" data-hide='1'>
													...
													<label id="bdp-options-button" for="bdp_edd_addtocartbutton_alignment_left"><?php esc_html_e( 'Left', 'blog-designer-pro' ); ?></label>
													...
													<label id="bdp-options-button" for="bdp_edd_addtocartbutton_alignment_center" class="bdp_edd_addtocartbutton_alignment_center"><?php esc_html_e( 'Center', 'blog-designer-pro' ); ?></label>
													...
													<label id="bdp-options-button" for="bdp_edd_addtocartbutton_alignment_right"><?php esc_html_e( 'Right', 'blog-designer-pro' ); ?></label>
												</fieldset>
											</div>
										</li>
														...
														<div class="bdp-typography-content">
															<div class="bdp-border-wrap">
																...
																<div class="bdp-border-wrapper bdp-border-wrapper1">
																	...
																	<div class="bdp-border-cover">
																		<div class="bdp-border-content">
																			<?php $bdp_edd_addtocartbutton_borderbuttom = isset( $bdp_settings['bdp_edd_addtocartbutton_borderbuttom'] ) ? $bdp_settings['bdp_edd_addtocartbutton_borderbuttom'] : '0'; ?>
																			<input type="number" id="bdp_edd_addtocartbutton_borderbuttom" name="bdp_edd_addtocartbutton_borderbuttom" step="1" min="0" value="<?php echo esc_attr( $bdp_edd_addtocartbutton_borderbuttom ); ?>" onkeypress="return isNumberKey(event)">
																		</div>
																	</div>
																	<div class="bdp-border-cover">
																		<div class="bdp-border-content">
														...
														<div class="bdp-typography-content">
															<div class="bdp-border-wrap">
																...
																<div class="bdp-border-wrapper bdp-border-wrapper1">
																	...
																	<div class="bdp-border-cover">
																		<div class="bdp-border-content">
																			<?php $bdp_edd_addtocartbutton_hover_borderbuttom = isset( $bdp_settings['bdp_edd_addtocartbutton_hover_borderbuttom'] ) ? $bdp_settings['bdp_edd_addtocartbutton_hover_borderbuttom'] : '0'; ?>
																			<input type="number" id="bdp_edd_addtocartbutton_hover_borderbuttom" name="bdp_edd_addtocartbutton_hover_borderbuttom" step="1" min="0" value="<?php echo esc_attr( $bdp_edd_addtocartbutton_hover_borderbuttom ); ?>" onkeypress="return isNumberKey(event)">
																		</div>
																	</div>
																	<div class="bdp-border-cover">
																		<div class="bdp-border-content">
										...
										<li class="bdp_edd_add_to_cart_tr">
											...
											<div class="bdp-right bdp-border-cover">
												<span class="fas fa-question-circle bdp-tooltips-icon bdp-tooltips-icon-color"><span class="bdp-tooltips"><?php esc_html_e( 'Set purchase button padding', 'blog-designer-pro' ); ?></span></span>
												<div class="bdp-padding-wrapper bdp-padding-wrapper1 bdp-border-wrap">
													<div class="bdp-padding-cover">
														<div class="bdp-padding-label">
															<span class="bdp-key-title">
										...
										<li class="bdp_edd_add_to_cart_tr">
											...
											<div class="bdp-right bdp-border-cover">
												<span class="fas fa-question-circle bdp-tooltips-icon bdp-tooltips-icon-color"><span class="bdp-tooltips"><?php esc_html_e( 'Set purchase button margin', 'blog-designer-pro' ); ?></span></span>
												<div class="bdp-padding-wrapper bdp-padding-wrapper1 bdp-border-wrap">
													<div class="bdp-padding-cover">
														<div class="bdp-padding-label">
															<span class="bdp-key-title">
										...
										<li class="bdp_edd_add_to_cart_tr">
											...
											<div class="bdp-typography-wrapper bdp-typography-wrapper1">
												<div class="bdp-typography-cover">
													...
													<div class="bdp-typography-content">
														<?php
    													if ( isset( $bdp_settings['bdp_edd_addtocart_button_fontface'] ) && '' != $bdp_settings['bdp_edd_addtocart_button_fontface'] ) { //phpcs:ignore
															...
															<div class="select-cover">
																<select name="bdp_edd_addtocart_button_fontface" id="bdp_edd_addtocart_button_fontface">
																	...
																	foreach ( $font_family as $key => $value ) {
																		...
																		echo "<option value='" . esc_attr( str_replace( '"', '', $value['label'] ) ) . "'";
    																	if ( '' != $bdp_edd_addtocart_button_fontface && ( str_replace( '"', '', $bdp_edd_addtocart_button_fontface ) == str_replace( '"', '', $value['label'] ) ) ) { //phpcs:ignore
																			echo ' selected';
																		}
												...
												<div class="bdp-typography-cover">
													<div class="bdp-typography-label">
														...
														<span class="fas fa-question-circle bdp-tooltips-icon"><span class="bdp-tooltips"><?php esc_html_e( 'Select purchase button font size', 'blog-designer-pro' ); ?></span></span>
													</div>
													<div class="bdp-typography-content">
														<?php
                                                        if ( isset( $bdp_settings['bdp_edd_addtocart_button_fontsize'] ) && '' != $bdp_settings['bdp_edd_addtocart_button_fontsize'] ) { //phpcs:ignore
															$bdp_edd_addtocart_button_fontsize = $bdp_settings['bdp_edd_addtocart_button_fontsize'];
														} else {
															$bdp_edd_addtocart_button_fontsize = 14;
														}
														?>
														<div class="grid_col_space range_slider_fontsize" id="bdp_edd_addtocart_button_fontsizeInput" ></div>
														<div class="slide_val"><span></span><input class="grid_col_space_val range-slider__value" name="bdp_edd_addtocart_button_fontsize" id="bdp_edd_addtocart_button_fontsize" value="<?php echo esc_attr( $bdp_edd_addtocart_button_fontsize ); ?>" onkeypress="return isNumberKey(event)" /></div>
													</div>
												</div>
												...
												<div class="bdp-typography-cover">
													<div class="bdp-typography-label">
														...
														<span class="fas fa-question-circle bdp-tooltips-icon"><span class="bdp-tooltips"><?php esc_html_e( 'Select purchase button font weight', 'blog-designer-pro' ); ?></span></span>
													</div>
													<div class="bdp-typography-content">
												...
												<div class="bdp-typography-cover">
													<div class="bdp-typography-label">
														...
														<span class="fas fa-question-circle bdp-tooltips-icon"><span class="bdp-tooltips"><?php esc_html_e( 'Select purchase button line height', 'blog-designer-pro' ); ?></span></span>
													</div>
													<div class="bdp-typography-content">
														<div class="input-type-number">
														<?php
												...
												<div class="bdp-typography-label">
													...
													<span class="fas fa-question-circle bdp-tooltips-icon"><span class="bdp-tooltips"><?php esc_html_e( 'Display purchase button italic font style', 'blog-designer-pro' ); ?></span></span><?php $bdp_edd_addtocart_button_font_italic = isset( $bdp_settings['bdp_edd_addtocart_button_font_italic'] ) ? $bdp_settings['bdp_edd_addtocart_button_font_italic'] : '0'; ?>
												</div>
												<div class="bdp-typography-content">
													<fieldset class="bdp-social-options bdp-display_author buttonset">
											...
											<div class="bdp-typography-cover">
												<div class="bdp-typography-label">
													...
													<span class="fas fa-question-circle bdp-tooltips-icon"><span class="bdp-tooltips"><?php esc_html_e( 'Select purchase button text transform style', 'blog-designer-pro' ); ?></span></span>
												</div>
												<div class="bdp-typography-content">
											...
											<div class="bdp-typography-cover">
												<div class="bdp-typography-label">
													...
													<span class="fas fa-question-circle bdp-tooltips-icon"><span class="bdp-tooltips"><?php esc_html_e( 'Select purchase button text decoration style', 'blog-designer-pro' ); ?></span></span>
												</div>
												<div class="bdp-typography-content">
												...
												<div class="bdp-typography-cover">
													<div class="bdp-typography-label">
														...
														<span class="fas fa-question-circle bdp-tooltips-icon"><span class="bdp-tooltips"><?php esc_html_e( 'Enter purchase button letter spacing', 'blog-designer-pro' ); ?></span></span>
													</div>
													<div class="bdp-typography-content">
														<div class="input-type-number">
					...
					<div class="inside">
						<ul class="bdp-settings bdp-lineheight">
							...
							<li class="related-post-positions">
								...
								<div class="bdp-right">
									<span class="fas fa-question-circle bdp-tooltips-icon"><span class="bdp-tooltips"><?php esc_html_e( 'Select related product postion', 'blog-designer-pro' ); ?></span></span>
									<?php
							...
							<li>
								<div class="bdp-left"><span class="bdp-key-title"><?php esc_html_e( 'Related Product Title Font Size', 'blog-designer-pro' ); ?></span></div>
								<div class="bdp-right">
							...
							<li>
								...
								<div class="bdp-right">
									<span class="fas fa-question-circle bdp-tooltips-icon"><span class="bdp-tooltips"><?php esc_html_e( 'Select sorting order of related products', 'blog-designer-pro' ); ?></span></span>
									<?php
									$related_orderby = '';
							...
							<li class="content-firstletter-tr">
								...
								<div class="bdp-right">
								<span class="fas fa-question-circle bdp-tooltips-icon"><span class="bdp-tooltips"><?php esc_html_e( 'Show purchase button', 'blog-designer-pro' ); ?></span></span>
							...
							<li>
								...
								<div class="bdp-right">
									<span class="fas fa-question-circle bdp-tooltips-icon"><span class="bdp-tooltips"><?php esc_html_e( 'Enable/Disable related product date', 'blog-designer-pro' ); ?></span></span>
									<?php
	...
	<div id="popupdiv-single" class="bdp-template-popupdiv" style="display: none;">
		...
		foreach ( $tempate_list as $key => $value ) {
			?>
			<div class="template-thumbnail <?php echo esc_attr( $value['class'] ); ?>" <?php echo ( isset( $value['data'] ) && '' != $value['data'] ) ? 'data-value="' . $value['data'] . '"' : ''; //phpcs:ignore ?>>
