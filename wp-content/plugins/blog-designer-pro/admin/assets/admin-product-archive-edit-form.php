...
if ( isset( $_GET['page'] ) && 'bdp_add_product_archive_layout' === $_GET['page'] ) { //phpcs:ignore
			...
			<div class="postbox-container bd-settings-wrappers bd_poststuff">
				...
				<div class="bd-menu-setting">
					...
					<ul class="bd-setting-handle">
						<li data-show="bdpproductgeneral" <?php echo $bdpgeneral_class; //phpcs:ignore ?>>
						...
						if ( Bdp_Woocommerce::is_woocommerce_plugin() ) {
							?>
							<li data-show="bdpproductarchivesetting" <?php echo $bdpproductsetting_class; //phpcs:ignore ?>>
				...
				<div id="bdpproductgeneral" class="postbox postbox-with-fw-options" <?php echo $bdpgeneral_class_show; //phpcs:ignore ?>>
					<div class="inside">
						<ul class="bdp-settings bdp-lineheight">
							...
							<li>
								...
								<div class="bdp-right">
									...
									<input type="text" name="archive_name" id="archive_name" value="<?php echo stripslashes( $archive_name ); //phpcs:ignore ?>" placeholder="<?php esc_attr_e( 'Enter archive layout name', 'blog-designer-pro' ); ?>">
								</div>
							</li>
							...
							<li class="post-category">
								...
								<div class="bdp-right">
									...
									<?php
										...
										$db_categories    = $wpdb->get_results( 'SELECT product_sub_categories FROM ' . $wpdb->prefix . 'bdp_product_archives WHERE product_archive_template = "category_template"' ); //phpcs:ignore
							...
							<li class="post-tag">
								...
								<div class="bdp-right">
									...
									$db_tags     = $wpdb->get_results( 'SELECT product_sub_categories FROM ' . $wpdb->prefix . 'bdp_product_archives WHERE product_archive_template = "tag_template"' ); //phpcs:ignore
									$db_tag_list = array();
									if ( $db_tags ) {
						...
						<ul class="bdp-settings bdp-lineheight">
							...
							<li class="advance_contents_tr advance_contents_settings advance_contents_settings_character">
								...
								<span class="fas fa-question-circle bdp-tooltips-icon bdp-tooltips-icon-select"><span class="bdp-tooltips"><?php esc_html_e( 'Select display content stoppage characters', 'blog-designer-pro' ); ?></span></span>
									...
									<select data-placeholder="<?php esc_attr_e( 'Choose stoppage characters', 'blog-designer-pro' ); ?>" class="chosen-select" multiple style="width:220px;" name="contents_stopage_character[]" id="contents_stopage_character"><?php //phpcs:disable ?>
										<option value="." <?php echo ( in_array( '.', $contents_stopage_character ) ) ? 'selected="selected"' : ''; ?>> . </option>
										<option value="?" <?php echo ( in_array( '?', $contents_stopage_character ) ) ? 'selected="selected"' : ''; ?>> ? </option>
										<option value="," <?php echo ( in_array( ',', $contents_stopage_character ) ) ? 'selected="selected"' : ''; ?>> , </option>
										<option value=";" <?php echo ( in_array( ';', $contents_stopage_character ) ) ? 'selected="selected"' : ''; ?>> ; </option>
										<option value=":" <?php echo ( in_array( ':', $contents_stopage_character ) ) ? 'selected="selected"' : ''; ?>> : </option>
									</select><?php //phpcs:enable ?>
								</div>
							</li>
				...
				<div id="bdpproductarchivesetting" class="postbox postbox-with-fw-options" <?php echo $bdpproductsetting_class_show; //phpcs:ignore ?>>
					<div class="inside">
						<ul class="bdp-settings bdp-lineheight">
							<li>
								<div class="bdp-left">
