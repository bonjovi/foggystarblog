...
if ( isset( $_GET['page'] ) && 'add_edd_archive' === $_GET['page'] ) { //phpcs:ignore
	$page                = esc_attr( $_GET['page'] ); //phpcs:ignore
	$bdp_settings        = array();
	$custom_archive_type = '';
	if ( isset( $_GET['id'] ) && ! empty( $_GET['id'] ) ) { //phpcs:ignore
		$archive_id      = intval( $_GET['id'] ); //phpcs:ignore
		$tableName       = $wpdb->prefix . 'bdp_edd_archives'; //phpcs:ignore
		$getQry          = "SELECT * FROM $tableName WHERE ID = $archive_id"; //phpcs:ignore
		$get_allsettings = $wpdb->get_results( $getQry, ARRAY_A ); //phpcs:ignore
			...
			<div class="postbox-container bd-settings-wrappers bd_poststuff">
				...
				<div class="bd-menu-setting">
					...
					if ( Bdp_Posts::postbox_classes( 'bdpdownloadgeneral', $page ) ) {
						...
						$bdpeddsetting_class      = 'class="bd-active-tab"';
						$bdpeddsetting_class_show = 'style="display: block;"';
					...
					<ul class="bd-setting-handle">
						<li data-show="bdpdownloadgeneral" <?php echo $bdpgeneral_class; //phpcs:ignore ?>>
						...
						<li data-show="bdpeddsettings" <?php echo $bdpeddsetting_class; //phpcs:ignore ?>>
				...
				<div id="bdpdownloadgeneral" class="postbox postbox-with-fw-options" <?php echo $bdpgeneral_class_show; //phpcs:ignore ?>>
					<div class="inside">
						...
						<h3 class="bdp-table-title"><?php esc_html_e( 'Select Product Archive Layout', 'blog-designer-pro' ); ?></h3>
							<li>
								<div class="bdp-left">
									<p class="bdp-margin-bottom-50"><?php esc_html_e( 'Select your favorite layout from 54 powerful archive layouts', 'blog-designer-pro' ); ?>. </p>
										...
										$template_color_preset = array(
											...
											'clicky'      => array(
												...
												'clicky_violet' => array(
													...
													'preset_value' => 'template_bgcolor:#F1E5FD,template_ftcolor:#CA9CFD,template_fthovercolor:#4E1F81,template_titlecolor:#983DFB,template_titlehovercolor:#321452,template_titlebackcolor:#F1E5FD,template_contentcolor:#4E1F81,template_readmorecolor:#983DFB,template_readmorebackcolor:#F1E5FD,template_readmore_hover_backcolor:#CA9CFD,beforeloop_readmorecolor:#983DFB,beforeloop_readmorebackcolor:#F1E5FD,beforeloop_readmorehovercolor:#983DFB,beforeloop_readmorehoverbackcolor:#CA9CFD,bdp_edd_price_color:#983DFB,bdp_edd_addtocart_textcolor:#F1E5FD,bdp_edd_addtocart_backgroundcolor:#983DFB,bdp_edd_addtocart_text_hover_color:#F1E5FD,bdp_edd_addtocart_hover_backgroundcolor:#4E1F81',
												...
												'clicky_goldenrod' => array(
													...
													'preset_value' => 'template_bgcolor:#F4EDDD,template_ftcolor:#D7BD81,template_fthovercolor:#5B4204,template_titlecolor:#B28007,template_titlehovercolor:#3A2A02,template_titlebackcolor:#F4EDDD,template_contentcolor:#5B4204,template_readmorecolor:#B28007,template_readmorebackcolor:#F4EDDD,template_readmore_hover_backcolor:#D7BD81,beforeloop_readmorecolor:#B28007,beforeloop_readmorebackcolor:#F4EDDD,beforeloop_readmorehovercolor:#B28007,beforeloop_readmorehoverbackcolor:#D7BD81,bdp_edd_price_color:#F4EDDD, bdp_edd_addtocart_textcolor:#F4EDDD,bdp_edd_addtocart_backgroundcolor:#B28007,bdp_edd_addtocart_text_hover_color:#F4EDDD,bdp_edd_addtocart_hover_backgroundcolor:#5B4204',
											...
											'evolution'   => array(
												...
												'evolution_buttercup' => array(
													...
													'preset_value' => 'template_bgcolor:#FAF0E2,template_alterbgcolor:#E2EDFA,template_ftcolor:#555555,template_fthovercolor:#E5A452,template_titlecolor:#DF8D27,template_titlehovercolor:#E5A452,template_titlebackcolor:#ffffff,template_readmorecolor:#ffffff,template_readmorebackcolor:#E5A452,template_contentcolor:#333333,beforeloop_readmorecolor:#ffffff,beforeloop_readmorebackcolor:#E5A452,beforeloop_readmorehovercolor:#E5A452,beforeloop_readmorehoverbackcolor:#ffffff,bdp_edd_price_color:#DF8D27,bdp_edd_addtocart_textcolor:#ffffff,bdp_edd_addtocart_backgroundcolor:#DF8D27,bdp_edd_addtocart_text_hover_color:#ffffff,bdp_edd_addtocart_hover_backgroundcolor:#333333',
											...
											'schedule'    => array(
												...
												'schedule_flamenco' => array(
													'preset_name' => esc_html__( 'Flamenco', 'blog-designer-pro' ),
													'preset_value' => 'template_color:#683C6F,template_bgcolor:#FFF3ED,template_ftcolor:#683C6F,template_fthovercolor:#ffffff,template_titlecolor:#683C6F,template_titlehovercolor:#484848,template_titlebackcolor:#FFF3ED,template_contentcolor:#7b7b7b,template_readmorecolor:#683C6F,template_readmorebackcolor:#FFF3ED,bdp_edd_price_color:#484848,bdp_edd_addtocart_textcolor:#ffffff,bdp_edd_addtocart_backgroundcolor:#683C6F,bdp_edd_addtocart_text_hover_color:#683C6F,bdp_edd_addtocart_hover_backgroundcolor:#FFF3ED,winter_category_color:#683C6F',
													'display_value' => '#683C6F,#FFF3ED,#683C6F,#484848',
												),
												...
												<?php foreach ( $single_template as $name => $value ) { ?>
													...
													" data-value="<?php echo esc_attr( $value['preset_value'] ); ?>">
														<label>
															...
															<?php echo esc_attr( $value['preset_name'] ); ?>
														</label>
														<?php
							...
							<li class="post-category">
								...
								<div class="bdp-right">
									...
									<?php
										...
										$db_categories    = $wpdb->get_results( 'SELECT download_sub_categories FROM ' . $wpdb->prefix . 'bdp_edd_archives WHERE download_archive_template = "category_template"' ); //phpcs:ignore
							...
							<li class="post-tag">
								...
								<div class="bdp-right">
									...
									$db_tags     = $wpdb->get_results( 'SELECT download_sub_categories FROM ' . $wpdb->prefix . 'bdp_edd_archives WHERE download_archive_template = "tag_template"' ); //phpcs:ignore
									$db_tag_list = array();
									if ( $db_tags ) {
											...
											if ( ! empty( $taxonomy_name ) ) {
												...
												<div class="bdp-typography-cover display-custom-taxonomy">
													<div class="bdp-typography-label">
														...
														<span class="fas fa-question-circle bdp-tooltips-icon"><span class="bdp-tooltips"><?php echo esc_html__( 'Show', 'blog-designer-pro' ) . ' ' . esc_html( $taxonomy_name->label ); ?></span></span>
													</div>
						...
						<ul class="bdp-settings">
							...
							<li>
								...
								<div class="bdp-right active_post_list">
									...
									if ( 'category_template' === $custom_archive_type || 'tag_template' === $custom_archive_type && '' != $template_id ) { //phpcs:ignore
									...
									if ( $bdp_timeline_the_query ) {
										...
										foreach ( $bdp_timeline_the_query as $post ) { //phpcs:ignore
											$post__id = get_the_ID();
											if ( $timeline_start_from == get_the_date( 'd/m/Y', $post__id ) ) { //phpcs:ignore
												?>
							...
							<li>
								<div class="bdp-left">
									<span class="bdp-key-title">
										<?php esc_html_e( 'Product Height (px)', 'blog-designer-pro' ); ?>
									</span>
								</div>
								<div class="bdp-right">
							...
							<li>
								<div class="bdp-left">
									<span class="bdp-key-title">
										<?php esc_html_e( 'Margin between Product (px)', 'blog-designer-pro' ); ?>
									</span>
								</div>
								<div class="bdp-right">
									...
									<?php $template_post_margin = ( isset( $bdp_settings['template_post_margin'] ) && $bdp_settings['template_post_margin'] != '' ) ? $bdp_settings['template_post_margin'] : 20; //phpcs:ignore ?>
				...
				<div id="bdpstandard" class="postbox postbox-with-fw-options" <?php echo $bdpstandard_class_show; //phpcs:ignore ?>>
					<div class="inside">
						<ul class="bdp-settings bdp-lineheight">
							...
							<h3 class="bdp-table-title bdp-table-sub-title"><?php esc_html_e( 'Background Settings', 'blog-designer-pro' ); ?></h3>
								...
								<div class="bdp-typography-wrapper bdp-typography-wrapper1">
									<div class="bdp-typography-cover">
										<div class="bdp-typography-label">
											...
											<span class="fas fa-question-circle bdp-tooltips-icon"><span class="bdp-tooltips"><?php esc_html_e( 'Select post content font family', 'blog-designer-pro' ); ?></span></span>
										</div>
										<div class="bdp-typography-content">
											<?php
									...
									<div class="bdp-typography-cover">
										...
										<div class="bdp-typography-content">
											<div class="grid_col_space range_slider_fontsize" id="content_fontsize_slider" data-value="<?php echo esc_attr( $bdp_settings['content_fontsize'] ); ?>"></div>
											<div class="slide_val"><span></span><input class="grid_col_space_val range-slider__value" name="content_fontsize" id="content_fontsize" value="<?php echo esc_attr( $bdp_settings['content_fontsize'] ); ?>" onkeypress="return isNumberKey(event)" /></div>
										</div>
									</div>
					...
					<div class="inside">
						<ul class="bdp-settings bdp-lineheight">
							...
							<li class="blog-post-grid-height-tr">
								...
								<div class="bdp-right">
									<span class="fas fa-question-circle bdp-tooltips-icon"><span class="bdp-tooltips"><?php esc_html_e( 'Enter blog grid height', 'blog-designer-pro' ); ?></span></span>
									...
									<select id="bdp_media_size" name="bdp_media_size">
										...
										foreach ( $image_size as $s ) { //phpcs:ignore
											...
											if ( in_array( $s, array( 'thumbnail', 'medium', 'large' ) ) ) { //phpcs:ignore
												?>
												<option value="<?php echo esc_attr( $s ); ?>" <?php echo ( isset( $bdp_settings['bdp_media_size'] ) && $bdp_settings['bdp_media_size'] == $s ) ? 'selected="selected"' : ''; ?>> <?php echo esc_attr( $s ) . ' (' . esc_html( get_option( $s . '_size_w' ) ) . 'x' . esc_html( get_option( $s . '_size_h' ) ) . ')'; //phpcs:ignore ?> </option>
												<?php
											} else {
												if ( isset( $_wp_additional_image_sizes ) && isset( $_wp_additional_image_sizes[ $s ] ) ) {
													?>
													<option value="<?php echo esc_attr( $s ); ?>" <?php echo ( isset( $bdp_settings['bdp_media_size'] ) && $bdp_settings['bdp_media_size'] == $s ) ? 'selected="selected"' : ''; ?>> <?php echo esc_attr( $s ) . ' (' . esc_html( $_wp_additional_image_sizes[ $s ]['width'] ) . 'x' . esc_html( $_wp_additional_image_sizes[ $s ]['height'] ) . ')'; //phpcs:ignore ?> </option>
													<?php
												}
											}
										}
							...
							<li>
								...
								<div class="bdp-right">
									...
									<select name="template_slider_effect" id="template_slider_effect">
										<option value="slide" 
										<?php
										if ( $bdp_settings[ 'slide' === 'template_slider_effect' ] ) { //phpcs:ignore
											echo 'selected="selected"';
										}
										?>
										>
					...
					<div class="inside">
						<ul class="bdp-settings bdp-lineheight">
							...
							<li class="post_date_format_tr">
								...
								<div class="bdp-right">
									...
									<select name="post_date_format" id="post_date_format">
										...
										<option value="F j, Y g:i a"  <?php echo selected( 'F j, Y g:i a', $post_date_format ); ?>><?php echo esc_attr( get_the_time( 'F j, Y g:i a' ) ); //phpcs:ignore ?></option>
										<option value="F j, Y"  <?php echo selected( 'F j, Y', $post_date_format ); ?>><?php echo esc_attr( get_the_time( 'F j, Y' ) ); //phpcs:ignore ?></option>
										<option value="F, Y"  <?php echo selected( 'F, Y', $post_date_format ); ?>><?php echo esc_attr( get_the_time( 'F, Y' ) ); //phpcs:ignore ?></option>
										<option value="j F  Y"  <?php echo selected( 'j F  Y', $post_date_format ); ?>><?php echo esc_attr( get_the_time( 'j F  Y' ) ); //phpcs:ignore ?></option>
										<option value="g:i a"  <?php echo selected( 'g:i a', $post_date_format ); ?>><?php echo esc_attr( get_the_time( 'g:i a' ) ); //phpcs:ignore ?></option>
										<option value="g:i:s a"  <?php echo selected( 'g:i:s a', $post_date_format ); ?>><?php echo esc_attr( get_the_time( 'g:i:s a' ) ); //phpcs:ignore ?></option>
										<option value="l, F jS, Y"  <?php echo selected( 'l, F jS, Y', $post_date_format ); ?>><?php echo esc_attr( get_the_time( 'l, F jS, Y' ) ); //phpcs:ignore ?></option>
										<option value="M j, Y @ G:i"  <?php echo selected( 'M j, Y @ G:i', $post_date_format ); ?>><?php echo esc_attr( get_the_time( 'M j, Y @ G:i' ) ); //phpcs:ignore ?></option>
										<option value="Y/m/d g:i:s A"  <?php echo selected( 'Y/m/d g:i:s A', $post_date_format ); ?>><?php echo esc_attr( get_the_time( 'Y/m/d g:i:s A' ) ); //phpcs:ignore ?></option>
										<option value="Y/m/d"  <?php echo selected( 'Y/m/d', $post_date_format ); ?>><?php echo esc_attr( get_the_time( 'Y/m/d' ) ); //phpcs:ignore ?></option>
										<option value="d.m.Y"  <?php echo selected( 'd.m.Y', $post_date_format ); ?>><?php echo esc_attr( get_the_time( 'd.m.Y' ) ); //phpcs:ignore ?></option>
										<option value="d-m-Y"  <?php echo selected( 'd-m-Y', $post_date_format ); ?>><?php echo esc_attr( get_the_time( 'd-m-Y' ) ); //phpcs:ignore ?></option>
									</select>
								</div>
							</li>
							...
							<li class="archive_blog_order_by">
								...
								<div class="bdp-right">
									<span class="fas fa-question-circle bdp-tooltips-icon"><span class="bdp-tooltips"><?php esc_html_e( 'Select the order of products', 'blog-designer-pro' ); ?></span></span>
									<?php
							...
							<li class="bdp_post_status">
								...
								<div class="bdp-right">
									<span class="fas fa-question-circle bdp-tooltips-icon"><span class="bdp-tooltips"><?php esc_html_e( 'Select product status on archive layout', 'blog-designer-pro' ); ?></span></span>
										...
										<div class="bdp_selected_loader_image">
											<div class='bdp-dialog-loader-style' >
												<span class="bdp_loader_image_holder loader_hidden" >
													<?php echo $loaders[ $loader_style_hidden ]; //phpcs:ignore ?>
												</span>
											</div>
										</div>
									</div>
				...
				<div id="bdpeddsettings" class="postbox postbox-with-fw-options" <?php echo $bdpeddsetting_class_show; //phpcs:ignore ?>>
					<div class="inside">
						<ul class="bdp-settings bdp-lineheight">
							<li>
								<div class="bdp-left">
